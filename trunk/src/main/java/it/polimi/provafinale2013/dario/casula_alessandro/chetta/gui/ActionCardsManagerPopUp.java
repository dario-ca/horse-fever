...
public class ActionCardsManagerPopUp implements PopUp{
	...
	public ActionCardsManagerPopUp(HorseFeverController modelController) {
	...
	private void setup(){
		...
		actionCardsManagerFrame.setIconImage(Toolkit.getDefaultToolkit().getImage(GUI.icona));
		...
		actionCardsManagerFrame.setResizable(false);
	}
	
	private JPanel createTopPanel(){
		//acquisisco le/la carte/a azione del giocatore corrente
		ArrayList<ActionCard> currentPlayerActionCards = modelController.getCurrentPlayerActionCards();
		...
		namePanel.add(new JLabel(modelController.getCurrentPlayerName()+" posa le carte azione"));
		//creo il pannello dei bottoni
		JPanel buttonPanel=new JPanel(new FlowLayout(FlowLayout.CENTER));
		//creo l'action listener associato ai bottoni
		ActionCardsSelectionButtonsHandler actionCardsSelectionButtonsHandler = new ActionCardsSelectionButtonsHandler(this);
